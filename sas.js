...
function Acheterticket() {
    ...
    const tripid = Number(
        prompt("entre l Identifiant de trajet ")
    );
...
function annulertickets() {
    ...
    const ticketId = Number(
        prompt("entre l identifiant de ticket")
    );
...
while (true) {
    ...
    const choice = prompt("entre votre choix: ");
